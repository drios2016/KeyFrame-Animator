...
void SoModel::draw ( const GsMat& tr, const GsMat& pr, const light& l, int modelType)
 {
   float f[4]; 
 
	if (modelType == 4)
	{
		float sh = (float)_mtl1.shininess;
		if (sh < 0.001f) sh = 64;
		...
		if (_phong)
		{
			...
			glUniform4fv(_progphong.uniloc[6], 1, _mtl1.ambient.get(f));
			glUniform4fv(_progphong.uniloc[7], 1, _mtl1.specular.get(f));
		...
		else
		{
			...
			glUniform4fv(_proggouraud.uniloc[6], 1, _mtl1.ambient.get(f));
			glUniform4fv(_proggouraud.uniloc[7], 1, _mtl1.specular.get(f));
	...
	else
	{
		...
		if (_phong)
		{
			...
			glUniform4fv(_progphong.uniloc[4], 1, l.dif.get(f));
			glUniform4fv(_progphong.uniloc[5], 1, l.spe.get(f));
			glUniform4fv(_proggouraud.uniloc[6], 1, _mtl.amb.get(f));
			glUniform4fv(_proggouraud.uniloc[7], 1, _mtl.dif.get(f));
			glUniform4fv(_proggouraud.uniloc[8], 1, _mtl.spe.get(f));
